...
namespace UnityEngine.InputSystem.Switch {
	...
	[InitializeOnLoad]
#endif
	public static class NSO_SNESGamepadHID {
		static NSO_SNESGamepadHID() {
			InputDeviceMatcher matcher = new InputDeviceMatcher()
				.WithInterface("HID")
				.WithCapability("vendorId", 0x057e) // Nintendo
				.WithCapability("productId", 0x2017);

			//TextAsset json = Resources.Load<TextAsset>("SNES Controller");
		...
		private const string JSON = @"
{
    ...
    ""runInBackground"": """",
    ""commonUsages"": [],
    ""displayName"": ""NSO SNES Controller"",
    ""description"": """",
    ""type"": ""UnityEngine.InputSystem.Gamepad, Unity.InputSystem, Version=1.8.2.0, Culture=neutral, PublicKeyToken=null"",
    ""variant"": """",
